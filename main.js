...
const RED_EXCLUDE_KEYWORDS = ['Produit sur la chaussée', 'Reduction de vitesse', 'Circulation alternée', 'Restriction de voie', 'Voies rétrécies', 'Dépassement interdit', 'Réduction du nombre de voies', 'Obstacle '];
